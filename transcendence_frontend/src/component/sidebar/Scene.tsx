  ...
  return (
    <mesh ref={meshRef} position={[0, 0, 0]}>
      ...
      <MeshWobbleMaterial factor={0.2} speed={1} color={"#0088ff"}>
              <GradientTexture type={GradientType.Radial} innerCircleRadius={8} outerCircleRadius={'auto'} stops={[0, 0.9, 0]} colors={['#e63946', '#f1faee', '#a8dadc']} size={10} />
      </MeshWobbleMaterial>
    </mesh>
  );
};
...
const Scene = () => {
  ...
  return (
    ...
    <Canvas onPointerOver={() => setHovered(true)} onPointerOut={() => setHovered(false)}>
      ...
      {isHovered && (
        <>
          <Text3D position={[-1.9, -0.5, 0]} font={RobotoBoldTypeface}
          curveSegments={32}
          bevelEnabled
          bevelSize={0.04}
          bevelThickness={0.1}
          ...
          <Text3D position={[0.2, -0.5, 0]} font={RobotoBoldTypeface}
          curveSegments={32}
          bevelEnabled
          bevelSize={0.04}
          bevelThickness={0.1}
